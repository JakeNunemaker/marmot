"""
Base classes of for _simpy's shared resource types.
...
from _simpy.events import Event
...
class Put(Event):
    ...
    request if an exception (like an :class:`_simpy.exceptions.Interrupt` for
    example) occurs:
    ...
    def cancel(self):
        ...
        :class:`~_simpy.exceptions.Interrupt`.
