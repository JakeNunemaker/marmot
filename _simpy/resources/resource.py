...
"""
from _simpy.core import BoundClass
from _simpy.resources import base


class Preempted(object):
    """Cause of an preemption :class:`~_simpy.exceptions.Interrupt` containing
    information about the preemption.

    """
    def __init__(self, by, usage_since, resource):
        self.by = by
        """The preempting :class:`_simpy.events.Process`."""
...
class Request(base.Put):
    ...
    granted. Subclass of :class:`_simpy.resources.base.Put`.
...
class Release(base.Get):
    ...
    triggered immediately. Subclass of :class:`_simpy.resources.base.Get`.
...
class Resource(base.BaseResource):
    ...
    The *env* parameter is the :class:`~_simpy.core.Environment` instance the
    ...
    def __init__(self, env, capacity=1):
        ...
        :attr:`~_simpy.resources.base.BaseResource.put_queue`.
        """
...
class PriorityResource(Resource):
    """A :class:`~_simpy.resources.resource.Resource` supporting prioritized
    requests.
    ...
    :attr:`~_simpy.resources.base.BaseResource.put_queue` for details."""
    GetQueue = list
    """Type of the get queue. See
    :attr:`~_simpy.resources.base.BaseResource.get_queue` for details."""
...
class PreemptiveResource(PriorityResource):
    """A :class:`~_simpy.resources.resource.PriorityResource` with preemption.

    If a request is preempted, the process of that request will receive an
    :class:`~_simpy.exceptions.Interrupt` with a :class:`Preempted` instance as
    cause.
